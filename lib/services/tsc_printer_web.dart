...
class TscPrinter {
  ...
  static Future<void> printTestLabel() async {
    ...
    // Prompts the user to pick the printer.
    // Empty filters lists every device since the exact VID/PID of the TE244
    // may vary by interface module.
  ...
  /// Builds and sends a real product label to the TSC TE244.
  ///
  ...
  /// Existing simple test label.
  ///
  /// This is the exact test-label design selected for the product label.
  ...
  /// Existing test label.
  ///
  /// Kept in the file but not used by the current product-print flow.
